...
```{python}
# ============================================
# Өгөгдлийг ачаалах ба цэвэрлэх
# ТАЙЛБАР: CSV формат - Item(s),Item 1,Item 2,...
# Эхний багана = тоо (алгасах), үлдсэн = бүтээгдэхүүнүүд
# ============================================
transactions = []
...
lines = lines[1:] # Эхний мөр нь 'Item(s)' устгана

for line in lines:
    parts = [x.strip() for x in line.strip().split(',') if x.strip()]
    
    if len(parts) <= 1: # Хоосон мөрүүдийг алгасах
        continue
    
    cleaned_items = parts[1:]
    if cleaned_items:
        transactions.append(cleaned_items)

print("Худалдан авалтын тоо:", len(transactions))
